angular.module('AngularSEOApp', [])
    .controller('ContentController', function() {
        ...
        content.aboutDetail = "AngularSEO Filter is a SEO solution for AJAX frond-end sites with a JavaEE backend. The AJAX frond-end can be AngularJS, ReactJS and other AJAX frameworks.";
        ...
        content.aboutTitle2 = "Pre-render static page snapshots";
        content.aboutDetail2 = "When server started, SEO filter will crawl self site and generate static page snapshot for each one with all the dynamic content fully rendered. It will update the snapshots regularly according your configure.";

        content.aboutTitle3 = "Let crawlers see static content";
        content.aboutDetail3 = "SEO filter identify the crawl request by checking the User-Agent keyword . If it is Googlebot, Bingbot, etc, filter will response with the pre-rendered static page from the snapshot.";

        content.aboutTitle4 = "All hashbang URLs are well transformed";
